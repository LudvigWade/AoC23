...
public class Day17Task1 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		map.put(n, 0);
		Node temp;
		while (!(n.x == nbrofrows-1 && n.y == nbrofcols-1)) { //direction: 1 = going up, 2 = going down, 3 = going right, 4 = going left
			if (n.x+1 < nbrofrows && !(n.sameDir == 2 && n.direction == 2) && n.direction != 1) {
				if (n.direction == 2) {
			...
			if (n.x-1 >= 0 && !(n.sameDir == 2 && n.direction == 1) && n.direction != 2) {
				if (n.direction == 1) {
			...
			if (n.y+1 < nbrofcols && !(n.sameDir == 2 && n.direction == 3) && n.direction != 4) {
				if (n.direction == 3) {
			...
			if (n.y-1 >= 0 && !(n.sameDir == 2 && n.direction == 4) && n.direction != 3) {
				if (n.direction == 4) {
